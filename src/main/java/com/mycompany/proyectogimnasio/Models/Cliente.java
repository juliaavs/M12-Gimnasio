 ...
 * Utiliza propiedades de JavaFX para facilitar la vinculación con la TableView.
 */
public class Cliente {
    ...
    public Cliente(int idCliente, String dni, String nombre, String apellido, String password, String iban) {
    ...
    // --- Getters de Propiedades (para la TableView) ---
